...
| [Technical Note: Two Computable Invariants](docs/technical_note.md) | Long-form technical note consolidating setup, theorem statements, numerical anchors, operational crossover, and implementation mapping. |
